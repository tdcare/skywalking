 ...
 * @author carlvine500
 */
public class PrePostReceiveMessageHandlerDecoratorInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    private static final String ENHANCE_CLASS = "io.eventuate.tram.consumer.common.PrePostReceiveMessageHandlerDecorator";
    private static final String ENHANCE_METHOD = "accept";
    private static final String INTERCEPTOR_CLASS = "org.apache.skywalking.apm.plugin.tdcare.PrePostReceiveMessageHandlerDecoratorInterceptor";
